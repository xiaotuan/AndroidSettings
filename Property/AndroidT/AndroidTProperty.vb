...
' vnd/device/mediateksample/tb8766p1_64_bsp/vnd_tb8766p1_64_bsp.mk 文件中的如下宏的值：
...
Module AndroidTProperty
    ...
    Public Function GetProductName(ByRef info As ProjectInfo) As String
        ...
        Return FileUtils.GetMakeFileValue(originFilePath, customFilePath, "PRODUCT_SYSTEM_NAME", ":=")
    End Function
    ...
    Public Function GetProductModel(ByRef info As ProjectInfo) As String
        ...
        Dim customFilePath As String = info.ProjectPath & "/sys/weibu/" & info.MssiDirName & "/" & info.CustomDirName &
            "/alps/device/mediatek/system/" & info.MssiDirName & "/sys_" & info.MssiDirName & ".mk"
        Return FileUtils.GetMakeFileValue(originFilePath, customFilePath, "PRODUCT_MODEL", ":=")
    End Function
    ...
    Public Function GetProductBrand(ByRef info As ProjectInfo) As String
        ...
        Dim customFilePath As String = info.ProjectPath & "/sys/weibu/" & info.MssiDirName & "/" & info.CustomDirName &
            "/alps/device/mediatek/system/" & info.MssiDirName & "/sys_" & info.MssiDirName & ".mk"
        Return FileUtils.GetMakeFileValue(originFilePath, customFilePath, "PRODUCT_BRAND", ":=")
    End Function
    ...
    Public Function GetProductDevice(ByRef info As ProjectInfo) As String
        ...
        Dim customFilePath As String = info.ProjectPath & "/sys/weibu/" & info.MssiDirName & "/" & info.CustomDirName &
            "/alps/device/mediatek/system/" & info.MssiDirName & "/sys_" & info.MssiDirName & ".mk"
        Return FileUtils.GetMakeFileValue(originFilePath, customFilePath, "PRODUCT_SYSTEM_DEVICE", ":=")
    End Function
    ...
    Public Function GetProductManufacturer(ByRef info As ProjectInfo) As String
        ...
        Dim customFilePath As String = info.ProjectPath & "/sys/weibu/" & info.MssiDirName & "/" & info.CustomDirName &
            "/alps/device/mediatek/system/" & info.MssiDirName & "/sys_" & info.MssiDirName & ".mk"
        Return FileUtils.GetMakeFileValue(originFilePath, customFilePath, "PRODUCT_MANUFACTURER", ":=")
    End Function
    ...
    Public Function SetProductName(ByRef info As ProjectInfo, ByVal name As String) As Boolean
        ...
        Return FileUtils.SetMakeFileValue(sysOriginFilePath, sysCustomFilePath, vbLf, "PRODUCT_SYSTEM_NAME :=", "", "PRODUCT_SYSTEM_NAME := " & name) And
            FileUtils.SetMakeFileValue(vndOriginFilePath, vndCustomFilePath, vbLf, "PRODUCT_SYSTEM_NAME :=", "", "PRODUCT_SYSTEM_NAME := " & name)
    End Function
    ...
    Public Function SetProductModel(ByRef info As ProjectInfo, ByVal model As String) As Boolean
        ...
        Dim vndCustomFilePath As String = info.ProjectPath & "/vnd/weibu/" & info.PublicDirName & "/" & info.DriveDirName &
            "/alps/device/mediateksample/" & info.PublicDirName & "/vnd_" & info.PublicDirName & ".mk"
        Return FileUtils.SetMakeFileValue(sysOriginFilePath, sysCustomFilePath, vbLf, "PRODUCT_MODEL :=", "", "PRODUCT_MODEL := " & model) And
            FileUtils.SetMakeFileValue(vndOriginFilePath, vndCustomFilePath, vbLf, "PRODUCT_MODEL :=", "", "PRODUCT_MODEL := " & model)
    End Function
    ...
    Public Function SetProductBrand(ByRef info As ProjectInfo, ByVal brand As String) As Boolean
        ...
        Dim vndCustomFilePath As String = info.ProjectPath & "/vnd/weibu/" & info.PublicDirName & "/" & info.DriveDirName &
            "/alps/device/mediateksample/" & info.PublicDirName & "/vnd_" & info.PublicDirName & ".mk"
        Return FileUtils.SetMakeFileValue(sysOriginFilePath, sysCustomFilePath, vbLf, "PRODUCT_BRAND :=", "", "PRODUCT_BRAND := " & brand) And
            FileUtils.SetMakeFileValue(vndOriginFilePath, vndCustomFilePath, vbLf, "PRODUCT_BRAND :=", "", "PRODUCT_BRAND := " & brand)
    End Function
    ...
    Public Function SetProductDevice(ByRef info As ProjectInfo, ByVal device As String) As Boolean
        ...
        Dim vndCustomFilePath As String = info.ProjectPath & "/vnd/weibu/" & info.PublicDirName & "/" & info.DriveDirName &
            "/alps/device/mediateksample/" & info.PublicDirName & "/vnd_" & info.PublicDirName & ".mk"
        Return FileUtils.SetMakeFileValue(sysOriginFilePath, sysCustomFilePath, vbLf, "PRODUCT_SYSTEM_DEVICE :=", "", "PRODUCT_SYSTEM_DEVICE := " & device) And
            FileUtils.SetMakeFileValue(vndOriginFilePath, vndCustomFilePath, vbLf, "PRODUCT_SYSTEM_DEVICE :=", "", "PRODUCT_SYSTEM_DEVICE := " & device)
    End Function
    ...
    Public Function SetProductManufacturer(ByRef info As ProjectInfo, ByVal manufacturer As String) As Boolean
        ...
        Dim vndCustomFilePath As String = info.ProjectPath & "/vnd/weibu/" & info.PublicDirName & "/" & info.DriveDirName &
            "/alps/device/mediateksample/" & info.PublicDirName & "/vnd_" & info.PublicDirName & ".mk"
        Return FileUtils.SetMakeFileValue(sysOriginFilePath, sysCustomFilePath, vbLf, "PRODUCT_MANUFACTURER :=", "", "PRODUCT_MANUFACTURER := " & manufacturer) And
            FileUtils.SetMakeFileValue(vndOriginFilePath, vndCustomFilePath, vbLf, "PRODUCT_MANUFACTURER :=", "", "PRODUCT_MANUFACTURER := " & manufacturer)
    End Function
